                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-5 form-group">
                                        <div class="row">
                                            <div class="col-md-12">
                                                {!! Form::open(array('url'=>'panel/cliente','method'=>'GET','autocomplete'=>'off','role'=>'search'))!!}
                                                <div class="input-group">
                                                    <input class="form-control" type="search" name="buscar" value="{{$searchText}}" placeholder="Nombre del Cliente" >
                                    ...
                                    <div class="col-lg-7 form-group">
                                        ...
                                        <button class="btn btn-danger btn-ladda ladda-button" data-style="contract">
                                            <span class="ladda-label">
                                                <a href="{{route('index.cliente')}}" style="color: white">Restablecer
                                        ...
                                        <button class="btn btn-primary btn-ladda ladda-button" data-style="contract">
                                            <span class="ladda-label">
                                                <a href="{{route('create.cliente')}}" style="color: white">Nuevo cliente
                                                    <svg class="c-icon" style="max-width: 64px;margin-top: 0px;">
                                        ...
                                        <table class="table table-responsive-sm table-hover table-outline mb-0 table-sm">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">{{$per->tipo_documento}}</td>
                                                    <td class="text-center">{{$per->num_documento}}</td>
                                                    <td class="text-center">{{$per->telefono}}</td>
                                                    <td class="text-center">{{$per->email}}</td>
                                                    <td class="text-center">{{$per->direccion}}</td>
                                                    <td class="text-center">
                                                        <div class="btn-group">
                                                            ...
                                                            <div class="dropdown-menu" x-placement="bottom-start" style="will-change: transform; margin: 0px;">
                                                                <a class="dropdown-item" href="{{route('edit.cliente',$per->id)}}">
                                                                    <svg class="c-icon" style="max-width: 64px">
                                                                ...
                                                                <a  class="dropdown-item" data-toggle="modal" data-target="#modal-{{$per->id}}">
                                                                    <svg class="c-icon" style="max-width: 64px">
                                                                        <use xlink:href="/sprites/linear.svg#cil-delete">
                                                                            <svg id="cil-delete" viewBox="0 0 512 512">
